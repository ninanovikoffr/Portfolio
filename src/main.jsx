...
import NextPath from './NextPath' // Importa a página do NextPath
  ...
  return (
    <div className="construcao-page">
      ...
      <div className="container construcao-container">
        ...
        {/* Botão com a seta invertida à esquerda */}
        <a className="action-button" href="/" onClick={handleVoltar}>
          <svg xmlns="http://www.w3.org/2000/svg" width="9" height="17" viewBox="0 0 9 17" fill="none" style={{ transform: 'rotate(180deg)' }}>
...
function ActionButton({ href, children }) {
  ...
  return (
    <a className="action-button" href={href || "#contato"} onClick={handleClick}>
      <span>{children}</span>
          ...
          <div className="about__content">
            ...
            <div className="about__footer">
              <a 
                ...
                href={asset('Nina_Ribeiro_Curriculo.pdf')} 
                download="Nina_Ribeiro_Curriculo.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
...
function App() {
  ...
  if (rotasEmConstrucao.includes(currentPath)) {
    return <EmConstrucao />;
  }
